...
export default function Footer() {
  return (
    <footer className="mt-10 bg-navy-900 px-6 py-12 text-slate-300 md:px-12">
      <div className="grid gap-10 md:grid-cols-5">
        ...
        <div>
          <h4 className="mb-3 text-sm font-semibold text-gold-400">About the Creator</h4>
          <p className="text-sm font-medium text-white">{aboutCreator.name}</p>
          <p className="text-sm">{aboutCreator.role}</p>
        </div>
      </div>
